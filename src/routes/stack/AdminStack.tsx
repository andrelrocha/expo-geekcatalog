...
import ListAllGamesAdmin from '../../screens/Admin/ListAllGamesAdmin';
...
export default function AdminStack() {
  return (
    <MyStackNavigator>
        ...
        <Stack.Screen name="ListAllGamesAdmin" component={ListAllGamesAdmin} options={{ headerTitle: 'Games - Admin'}}/>
